      ...
      <v-flex xs12 sm8 md8>
        ...
        <v-card class="elevation-12"> 
          ...
          <v-card-title primary-title>
            <h3 class="headline mb-0">Add a new remark for offer ID: {{ $route.params.offer_id }}
...
<script type="text/javascript">
  ...
  export default {
    ...
    methods: {
      ...
      create() {
        this.form.post(`/api/inquiries/${this.$route.params.inquiry_id}/offers/${this.$route.params.offer_id}/remarks`)
          .then(data  =>  {
